const id = "ja/guides/getting-started.mdx";
						const collection = "docs";
						const slug = "ja/guides/getting-started";
						...
						const data = {title:"入門",description:"ScrewFastの包括的なドキュメントを探索して、プレミアムツールと建設サービスを詳しく見てください。",editUrl:true,head:[],template:"doc",sidebar:{order:1,label:"Getting Started",hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/home/graham/wip/screwfast/ScrewFast/src/content/docs/ja/guides/getting-started.mdx",
							rawData: undefined,
						};
